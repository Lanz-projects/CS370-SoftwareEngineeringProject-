    ...
    <Modal show={show} backdrop="static" keyboard={false}>
      ...
      <Modal.Body>
        <p>
          ...
          The platform, its creators, and administrators are not responsible for any damages, injuries, losses, payment, or inconveniences arising from the use of this web app. The platform does not guarantee the accuracy, reliability, or safety of any ride offers or requests posted on the app. Users are solely responsible for ensuring that the rides they offer or request are safe, legal, and in accordance with local laws. <br/><br/>
          4. No Responsibility Outside the App <br/>
          ...
          6. Features and Availability <br/>
          ...
          8. Modifications to the Agreement <br/>
